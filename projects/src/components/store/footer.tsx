        ...
        <div className="footer-grid">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-4 body-sm" style={{ color: "var(--text-muted)" }}>
              <span className="flex items-center gap-1.5"><Truck className="h-3.5 w-3.5" aria-hidden="true" /> Free COD</span>
              <span className="flex items-center gap-1.5"><Shield className="h-3.5 w-3.5" aria-hidden="true" /> Secure Payment</span>
              <span className="flex items-center gap-1.5"><Repeat className="h-3.5 w-3.5" aria-hidden="true" /> 7-Day Return</span>
              <span className="flex items-center gap-1.5"><Clock className="h-3.5 w-3.5" aria-hidden="true" /> Same Day Dispatch</span>
            </div>
          </div>
