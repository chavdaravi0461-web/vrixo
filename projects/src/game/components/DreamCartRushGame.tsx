...
export function DreamCartRushGame() {
  ...
  const [highScore, setHighScore] = useState(() =>
    typeof window === "undefined"
      ? 0
      : Number(localStorage.getItem("dreamcart-rush-high-score") ?? 0)
  );
  ...
  async function finishGame() {
    ...
    localStorage.setItem("dreamcart-rush-high-score", String(nextHigh));
