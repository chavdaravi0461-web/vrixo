      ...
      <section className="border border-[var(--dc-border)] bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black uppercase tracking-[0.04em] text-[var(--dc-heading)]">My Coupons</h1>
          </div>
          <Link href="/shop">
        ...
        <div className="mt-6 grid gap-4">
          {coupons?.length ? (
            coupons.map((coupon) => (
              <div key={coupon.id} className="border border-[var(--dc-border)] bg-[var(--dc-surface)] p-5">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="text-2xl font-black tracking-wide text-[var(--dc-heading)]">{coupon.code}</p>
            ...
            <div className="border border-dashed border-[var(--dc-surface-strong)] p-8 text-center">
              <h2 className="text-xl font-black uppercase tracking-[0.04em] text-[var(--dc-heading)]">No coupons yet</h2>
