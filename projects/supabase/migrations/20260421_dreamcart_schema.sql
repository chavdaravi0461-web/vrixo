-- Mirrors supabase/schema.sql for teams using Supabase CLI  s.
...
create table if not exists public.orders (
  ...
  payment_method text not null default 'cod' check (payment_method in ('cod', 'online', 'Cash on Delivery', 'Online Payment')),
  payment_status text not null default 'pending' check (payment_status in ('pending', 'cod_pending', 'paid', 'failed', 'refunded', 'Pending', 'Paid', 'Failed', 'Refunded')),
  order_status text not null default 'pending' check (order_status in ('pending', 'confirmed', 'processing', 'packed', 'shipped', 'delivered', 'cancelled', 'Pending', 'Confirmed', 'Packed', 'Shipped', 'Delivered', 'Cancelled')),
...
create table if not exists public.payments (
  ...
  status text not null default 'pending' check (status in ('pending', 'cod_pending', 'paid', 'failed', 'refunded', 'Pending', 'Paid', 'Failed', 'Refunded')),
...
alter table public.orders add constraint orders_payment_status_check
  check (payment_status in ('pending', 'cod_pending', 'paid', 'failed', 'refunded', 'Pending', 'Paid', 'Failed', 'Refunded'));

alter table public.orders drop constraint if exists orders_order_status_check;
alter table public.orders add constraint orders_order_status_check
  check (order_status in ('pending', 'confirmed', 'processing', 'packed', 'shipped', 'delivered', 'cancelled', 'Pending', 'Confirmed', 'Packed', 'Shipped', 'Delivered', 'Cancelled'));

alter table public.payments alter column status set default 'pending';
alter table public.payments drop constraint if exists payments_status_check;
alter table public.payments add constraint payments_status_check
  check (status in ('pending', 'cod_pending', 'paid', 'failed', 'refunded', 'Pending', 'Paid', 'Failed', 'Refunded'));
